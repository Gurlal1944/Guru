...
me=LINE("EANktPtx9ifYXDRO5Jz2.TvdRmJaim08TzpRrtq9y8G.1KmvhX/yZ96gzr8AFtHufmf1G/w4fHPyXCYfZwyo3Y0=h")
                    ...
                    if text is None:
                        ...
                        if PrankBotsData.startswith(Abouts["33"]):
                          if D in Owner or D in meM:
                            ...
                            groups = me.groups
                            for group in groups:
                                sendMessageWithFooter(group, "╭━━━━━╦BroadCast by GURU╦━━━━━╮\n{}".format(str(txt))+"\nD")
                        ...
                        if Gr in Sid['Red']:
                            ...
                            if Name in Sid['Reason'][Gr]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        e.sendMessage(Gr, "ι ѕee yoυ😁 👀" + " " + Name + " " + "\n . . .\n")
